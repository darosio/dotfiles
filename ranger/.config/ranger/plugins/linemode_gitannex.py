# https://github.com/fiatjaf/dotfiles/blob/master/ranger-plugins/linemode_gitannex.py
import ranger.api
    ...
    def infostring(self, file, metadata):
        ...
        try:
            o = subprocess.check_output(
                ['git-annex', 'metadata', file.path, '--json'])
...
class GitAnnexWhereisLinemode(ranger.core.linemode.LinemodeBase):
    ...
    def repositories(self):
        ...
        try:
            o = subprocess.check_output(['git-annex', 'info', '--json'])
        except subprocess.CalledProcessError:
            raise NotImplementedError
    ...
    def infostring(self, file, metadata):
        ...
        try:
            o = subprocess.check_output(
                ['git-annex', 'whereis', file.path, '--json'])
        except subprocess.CalledProcessError:
            raise NotImplementedError
