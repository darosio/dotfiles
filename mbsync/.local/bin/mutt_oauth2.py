...
ENCRYPTION_PIPE = ["gpg", "--encrypt", "--recipient", "danielepietroarosio@gmail.com"]
...
registrations = {
    ...
    "microsoft": {
        "authorize_endpoint": "https://login.microsoftonline.com/34c64e9f-d27f-4edd-a1f0-1397f0c84f94/oauth2/v2.0/authorize",
        "devicecode_endpoint": "https://login.microsoftonline.com/34c64e9f-d27f-4edd-a1f0-1397f0c84f94/oauth2/v2.0/devicecode",
        "token_endpoint": "https://login.microsoftonline.com/34c64e9f-d27f-4edd-a1f0-1397f0c84f94/oauth2/v2.0/token",
        "redirect_uri": "http://localhost",
        "tenant": "34c64e9f-d27f-4edd-a1f0-1397f0c84f94",
...
if args.authorize:
    ...
    if authflow in {"authcode", "localhostauthcode"}:
        ...
        if authflow == "authcode":
            ...
            _params = _up.parse_qs(_qs)
            authcode = _params["code"][0] if "code" in _params else raw
        else:
            print(
            ...
            class MyHandler(http.server.BaseHTTPRequestHandler):
                ...
                def do_GET(self) -> None:
                    ...
                    self.do_HEAD()
                    self.wfile.write(
                        b"<html><head><title>Authorization result</title></head>"
                    )
                    self.wfile.write(
...
def build_sasl_string(user, host, port, bearer_token) -> str | None:
