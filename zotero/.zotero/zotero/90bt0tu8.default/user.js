...
user_pref(
  ...
  "application/pdf,application/epub+zip,image/,audio/,video/",
);
...
user_pref(
  "extensions.zotero.translators.better-bibtex.path.git",
  "/usr/bin/git",
);
...
user_pref(
  "extensions.zotero.translators.better-bibtex.quickCopyPandocBrackets",
  true,
);
...
user_pref(
  ...
  '["pdf","epub","docx","djvu","doc","txt","rtf","zip","xlsx","xls"]',
);
...
user_pref(
  "extensions.zotero.Knowledge4Zotero.export.markdown-autoFilename",
  false,
);
user_pref("extensions.zotero.Knowledge4Zotero.export.markdown-autoSync", false);
user_pref(
  "extensions.zotero.Knowledge4Zotero.export.markdown-withYAMLHeader",
  false,
);
...
user_pref(
  "extensions.zotero.Knowledge4Zotero.persist.workspaceContext",
  '{"pinnedPane":""}',
);
user_pref(
  "extensions.zotero.Knowledge4Zotero.persist.workspaceOutline",
  '{"outlineType":1}',
);
user_pref("extensions.zotero.Knowledge4Zotero.syncNoteIds", '[""]');
user_pref(
  "extensions.zotero.Knowledge4Zotero.template.[ExportLatexFileContent]",
  '"${{\\n  return latexContent;\\n}}$"',
);
user_pref(
  "extensions.zotero.Knowledge4Zotero.template.[ExportMDFileContent]",
  '"${{\\n  return mdContent;\\n}}$"',
);
user_pref(
  "extensions.zotero.Knowledge4Zotero.template.[ExportMDFileHeaderV2]",
...
user_pref(
  "extensions.zotero.Knowledge4Zotero.template.[ExportMDFileNameV2]",
  '"${(noteItem.getNoteTitle ? noteItem.getNoteTitle().replace(/[/\\\\\\\\?%*:|\\"<> ]/g, \\"-\\") + \\"-\\" : \\"\\")}${noteItem.key}.md"',
);
user_pref(
  "extensions.zotero.Knowledge4Zotero.template.[QuickImportV2]",
  '"<blockquote>\\n${{\\n  return await Zotero.BetterNotes.api.convert.link2html(link, {noteItem, dryRun: _env.dryRun});\\n}}$\\n</blockquote>"',
);
user_pref(
  "extensions.zotero.Knowledge4Zotero.template.[QuickInsertV3]",
  '"// @use-markdown\\n[${linkText}](${link})"',
);
user_pref(
  "extensions.zotero.Knowledge4Zotero.template.[QuickNoteV5]",
...
user_pref(
  "extensions.zotero.panes.Knowledge4Zotero-windingwind-com-bn-note-inbound-link.open",
  true,
);
user_pref(
  "extensions.zotero.panes.Knowledge4Zotero-windingwind-com-bn-note-outbound-link.open",
  true,
);
user_pref(
  "extensions.zotero.panes.Knowledge4Zotero-windingwind-com-bn-note-relation.open",
  true,
);
user_pref(
  "extensions.zotero.scipdfresolvers",
  '[{"name":"Sci-Hub","method":"GET","url":"https://sci-hub.se/{doi}","mode":"html","selector":"#pdf","attribute":"src","automatic":true},{"name":"Sci-Hub","method":"GET","url":"https://sci-hub.st/{doi}","mode":"html","selector":"#pdf","attribute":"src","automatic":true},{"name":"Sci-Hub","method":"GET","url":"https://sci-hub.ru/{doi}","mode":"html","selector":"#pdf","attribute":"src","automatic":true},{"name":"Sci-Hub","method":"GET","url":"https://sci-hub.ren/{doi}","mode":"html","selector":"#pdf","attribute":"src","automatic":true},{"name":"Sci-Hub","method":"GET","url":"https://sci-hub.wf/{doi}","mode":"html","selector":"#pdf","attribute":"src","automatic":true},{"name":"Sci-Hub","method":"GET","url":"https://sci-hub.ee/{doi}","mode":"html","selector":"#pdf","attribute":"src","automatic":true}]',
);
user_pref(
  "extensions.zotero.zotero-reading-list.enable-keyboard-shortcuts",
  true,
);
user_pref(
  "extensions.zotero.zotero-reading-list.label-items-when-opening-file",
  false,
);
...
user_pref(
  "extensions.zotero.zotero-reading-list.readstatuscolumn-format-header-showicon",
  false,
);
user_pref(
...
user_pref(
  ...
  '{"zotero-reader-sidebar-pane":{"collapsed":"true"},"zotero-layout-switcher":{"orient":"horizontal"},"zotero-items-splitter":{"state":"collapsed","orient":"horizontal"},"zotero-context-splitter":{"state":"collapsed"},"zotero-context-splitter-stacked":{"state":"collapsed"},"zotero-collections-pane":{"width":"305"},"zotero-tag-selector-container":{"collapsed":"true"},"zotero-collections-splitter":{"state":""}}',
);
